...
def train(net,
    ...
    if overwrite and os.ispath(f"{folder_name}/{output_evaluation_path}"):
        print(f">>> Model already trained in {folder_name}. Delete {output_evaluation_path} or set 'overwrite=True' to force training.")
        return
    else:
